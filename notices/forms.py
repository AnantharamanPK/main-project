...
from .models import Notice, Community  # <-- NEW: Imported Community here
...
class NewNoticeForm(forms.ModelForm):
    ...
    # Target Department selection dropdown
    ...
    # --- NEW: Target Community selection dropdown ---
    target_community = forms.ModelChoiceField(
        ...
        help_text='Select a specific batch or leave as "All".'
    )
    ...
    class Meta:
        model = Notice
        # --- NEW: Added 'target_community' to the fields list ---
        fields = ['title', 'message', 'target_department', 'target_community', 'tags', 'attachment']
